<div class="page-section">
      ...
      <?php $__currentLoopData = $doctor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img style="height:200px !important" src="doctorimage/<?php echo e($doctors->image); ?>" alt="">
              <div class="meta">
  ...
  </div><?php /**PATH C:\xampp\htdocs\hmslaravel\resources\views/user/doctor.blade.php ENDPATH**/ ?>