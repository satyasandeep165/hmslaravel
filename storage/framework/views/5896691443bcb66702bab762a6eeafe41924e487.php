      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" style="background-color:green; color:white;" href="<?php echo e(url('myappointment')); ?>">My Appointment</a>
            </li>
  ...
  <div align="center" style="padding:70px;">
      ...
      <table>
          ...
          <tr style="background-color:black;" align="center">
              ...
              <td><a class="bt btn-danger" onclick="return confirm('Are you sure to delete this')" href="<?php echo e(url('cancel_appoint',$appoints->id)); ?>">Cancel</td>
          </tr>
...
</html><?php /**PATH C:\xampp\htdocs\hmslaravel\resources\views/user/my_appointment.blade.php ENDPATH**/ ?>